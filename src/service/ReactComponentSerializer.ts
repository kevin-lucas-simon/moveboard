...
export class ReactComponentSerializer {
    ...
    private deserializeElement(
        ...
        options: DeserializationOpts = {}, key?: string | number
    ): any {
        ...
        if (element instanceof Array) {
            return element.map((el, i) => {
                return this.deserializeElement(el, options, i);
            })
        }
        ...
        if (props.children) {
            props = { ...props, children: this.deserializeElement(props.children, options) }
        }
